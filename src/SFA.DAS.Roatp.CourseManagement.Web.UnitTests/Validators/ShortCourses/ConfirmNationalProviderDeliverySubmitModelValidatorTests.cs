...
public class ConfirmNationalProviderDeliverySubmitModelValidatorTests
{
    ...
    {
        var sut = new ConfirmNationalProviderDeliverySubmitModelValidator();
        var model = new ConfirmNationalProviderDeliverySubmitModel();
    ...
    {
        var sut = new ConfirmNationalProviderDeliverySubmitModelValidator();
        var model = new ConfirmNationalProviderDeliverySubmitModel() { HasNationalDeliveryOption = value };
