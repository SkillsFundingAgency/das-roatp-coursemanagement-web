...
public class ProviderContactUpdateStandardsSubmitViewModelValidatorTests
{
    ...
    {
        var model = new ProviderContactUpdateStandardsSubmitViewModel { EmailAddress = "test@test.com", PhoneNumber = "123" };
    ...
    {
        var model = new ProviderContactUpdateStandardsSubmitViewModel { EmailAddress = "test@test.com" };
        var sut = new ProviderContactUpdateStandardsSubmitViewModelValidator();
    ...
    {
        var model = new ProviderContactUpdateStandardsSubmitViewModel { PhoneNumber = "123" };
        var sut = new ProviderContactUpdateStandardsSubmitViewModelValidator();
    ...
    {
        var model = new ProviderContactUpdateStandardsSubmitViewModel { HasOptedToUpdateExistingStandards = selection, EmailAddress = "test@test.com", PhoneNumber = "123" };
        var sut = new ProviderContactUpdateStandardsSubmitViewModelValidator();
        var result = sut.TestValidate(model);
