...
{
    [Test, MoqAutoData]
    public async Task EditShortCourseRegionsController_GetAllStandardRegionsReturnsData_ReturnsView(
    ...
    [Test, MoqAutoData]
    public async Task EditShortCourseRegionsController_GetAllStandardRegionsReturnsData_VerifyMediatorIsInvoked(
        [Frozen] Mock<IMediator> mediatorMock,
        [Greedy] EditShortCourseRegionsController sut,
        GetAllStandardRegionsQueryResult queryResult,
        string larsCode)
    ...
    [Test, MoqAutoData]
    public async Task EditShortCourseRegionsController_GetAllStandardRegionsReturnsNull_RedirectsToPageNotFound(
        [Frozen] Mock<IMediator> mediatorMock,
        [Greedy] EditShortCourseRegionsController sut,
        string larsCode)
    {
