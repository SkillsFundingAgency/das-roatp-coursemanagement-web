...
[TestFixture]
public class CheckStandardsControllerPostTests
{
    [Test, MoqAutoData]
        ...
        int ukprn)
    {
        ...
        var result = await sut.ConfirmCheckStandards(ukprn);
    ...
    [Test, MoqAutoData]
    public async Task Post_AddProviderContactAndStandards_RedirectsToContactSavedPage(
      [Frozen] Mock<ISessionService> sessionServiceMock,
