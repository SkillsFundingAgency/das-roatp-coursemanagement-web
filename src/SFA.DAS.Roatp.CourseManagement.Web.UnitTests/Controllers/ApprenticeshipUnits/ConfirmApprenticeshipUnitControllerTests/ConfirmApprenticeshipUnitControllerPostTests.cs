...
public class ConfirmApprenticeshipUnitControllerPostTests
{
        ...
        ShortCourseSessionModel sessionModel)
    {
        ...
        // Act
        var response = sut.Index(new ConfirmApprenticeshipUnitSubmitModel());
        ...
        ShortCourseSessionModel sessionModel)
    {
        ...
        // Act
        var response = sut.Index(new ConfirmApprenticeshipUnitSubmitModel() { IsCorrectShortCourse = false });
        ...
        ShortCourseSessionModel sessionModel)
    {
        ...
        // Act
        var response = sut.Index(new ConfirmApprenticeshipUnitSubmitModel() { IsCorrectShortCourse = true });
