...
public class ConfirmLocationAddGetTests
{
    [Test]
        ...
        AddressItem addressItem)
    {
        ...
        // Act
        var result = await sut.ConfirmLocationAdd(apprenticeshipType) as RedirectToRouteResult;
        ...
        GetAllProviderLocationsQueryResult locationsResponse)
    {
        ...
        // Act
        await sut.ConfirmLocationAdd(apprenticeshipType);
