...
public class WhenInEditStandardsJourney_AndGettingLocationConfirmation
{
    ...
    [Test, MoqAutoData]
    public void When_AddressNotInTempData_Then_RedirectsToGetProviderCourseLocations(
        string larsCode,
        Mock<ITempDataDictionary> tempDataMock,
        [Greedy] ConfirmAddProviderLocationController sut)
    {
