...
[Route("{ukprn}/standards/add/select-location-option")]
public class SelectLocationOptionController : AddAStandardControllerBase
{
    ...
    public SelectLocationOptionController(ISessionService sessionService, ILogger<SelectLocationOptionController> logger, IValidator<LocationOptionSubmitModel> validator) : base(sessionService)
    {
        _logger = logger;
        _validator = validator;
    }

    [HttpGet(Name = RouteNames.GetAddStandardSelectLocationOption)]
    ...
    [HttpPost(Name = RouteNames.PostAddStandardSelectLocationOption)]
    public IActionResult SubmitLocationOption(LocationOptionSubmitModel submitModel)
    {
        ...
        {
            var viewModel = new SelectLocationOptionViewModel { };
