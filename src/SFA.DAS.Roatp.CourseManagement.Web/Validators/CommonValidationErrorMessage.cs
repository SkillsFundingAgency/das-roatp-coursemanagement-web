namespace SFA.DAS.Roatp.CourseManagement.Web.Validators
{
    public static class CommonValidationErrorMessage
    {
        ...
        public const string EmailLengthMessage = "Email address must be 256 characters or fewer";
        ...
        public const string WebsiteLengthMessage = "Website address must be 500 characters or fewer";
